...
from agenda.models import Gasto,Retiro,Configuracion
...
class PrintTicketPDFView(View):
    def get(self, request, venta_id):
        ...
        empresa = Configuracion.objects.all().first()
        template_path = 'ticket.html'
        context = {'venta': venta,'empresa':empresa,}
...
class VentaList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if desde and hasta:
            ...
            paginator = Paginator(ventas_filtradas, page_size)
